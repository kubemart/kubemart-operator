...
type FakeApps struct {
	Fake *FakeKubemartV1alpha1
	ns   string
}

var appsResource = schema.GroupVersionResource{Group: "kubemart.civo.com", Version: "v1alpha1", Resource: "apps"}

var appsKind = schema.GroupVersionKind{Group: "kubemart.civo.com", Version: "v1alpha1", Kind: "App"}
