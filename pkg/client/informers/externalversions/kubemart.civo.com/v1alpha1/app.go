...
import (
	...
	kubemartcivocomv1alpha1 "github.com/kubemart/kubemart-operator/apis/kubemart.civo.com/v1alpha1"
	versioned "github.com/kubemart/kubemart-operator/pkg/client/clientset/versioned"
	internalinterfaces "github.com/kubemart/kubemart-operator/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/kubemart/kubemart-operator/pkg/client/listers/kubemart.civo.com/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubemartV1alpha1().Apps(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubemartV1alpha1().Apps(namespace).Watch(context.TODO(), options)
			},
		},
		&kubemartcivocomv1alpha1.App{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *appInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubemartcivocomv1alpha1.App{}, f.defaultInformer)
}
